                ...
                <xsl:if test="@rend='spatial-search'">
                    ...
                    <div class="spatial-search-div" id="spatial-search-div">
                        ...
                        <select name="spatial-relation">
                            <option value="iswithin" ><i18n:text>xmlui.Spatial.Map.isWithin</i18n:text></option>
                            <xsl:choose>
                                <xsl:when test="contains(/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='request'][@qualifier='queryString'],'spatial-relation=intersect')">
                                    <option value="intersects" selected="true"><i18n:text>xmlui.Spatial.Map.Intersect</i18n:text></option>
                                </xsl:when>
                                <xsl:otherwise>
                                    <option value="intersects"><i18n:text>xmlui.Spatial.Map.Intersect</i18n:text></option>
                                </xsl:otherwise>
                            </xsl:choose>
                        </select>&#160;&#160;
                        -->
                        <input>
                            <xsl:attribute name="name">spatial-relation</xsl:attribute>
                            <xsl:attribute name="type">hidden</xsl:attribute>
                            <xsl:attribute name="value">intersects</xsl:attribute>
                        </input>
                        <input>
                            <xsl:attribute name="name">spatial-index</xsl:attribute>
                            <xsl:attribute name="id">spatial-index</xsl:attribute>
                            <xsl:attribute name="type">hidden</xsl:attribute>
                        </input>
    ...
    <xsl:template match="dri:field[@type='composite']" mode="formComposite">
        <div class="ds-form-content">
            ...
            <div>
                ...
                <!-- For location input type during submision!!-->
                <xsl:if test="@rend='submit-location'">
                    <div class="smallmap"
                         style="width: 100%; height: 200px; margin-top:3px; border: 1px solid #ccc; display:block; clear:both;">
                        <xsl:attribute name="id">
                            <xsl:value-of select="@id"/>
                        </xsl:attribute>
                    </div>
                    <script defer="defer" type="text/javascript">
                        ...
                        addItemsBoxToMap(document.getElementById (fieldID + '_west').value,document.getElementById (fieldID
                        + '_south').value,document.getElementById (fieldID + '_east').value,document.getElementById (fieldID
                        + '_north').value);
                        }
                    </script>
