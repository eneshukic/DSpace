...
<xsl:stylesheet
    ...
    <xsl:template name="itemDetailView-DIM">
        ...
        <xsl:choose>
            <xsl:when test="./mets:fileSec/mets:fileGrp[@USE='CONTENT' or @USE='BRANDED_PREVIEW' or @USE='ORIGINAL' or @USE='LICENSE']/mets:file">
                <h3><i18n:text>xmlui.dri2xhtml.METS-1.0.item-files-head</i18n:text></h3>
                <div class="file-list">
                    <xsl:apply-templates select="./mets:fileSec/mets:fileGrp[@USE='CONTENT' or @USE='BRANDED_PREVIEW' or @USE='ORIGINAL' or @USE='LICENSE' or @USE='CC-LICENSE']">
                    ...
                    <xsl:for-each select="dim:field[@element='identifier' and @qualifier='uri']">
                        ...
                        <script type="text/javascript">
                            ...
                            var qrcode = new QRCode(document.getElementById("qrcode"), {
                             ...
                             qrcode.makeCode('<xsl:copy-of select="./node()"/>');
                             //this.printQR();
                             document.getElementById("printQR").style.display="inline";
                             document.getElementById("genQR").style.display="none";
                             }
                        </script>
                        <a id="printQR" href="#" onclick="printQR();return false;" style="display: none;"><i18n:text>xmlui.ArtifactBrowser.ItemViewer.print_qr</i18n:text></a>
                        <a id="genQR" href="#" onclick="genQR();return false;"><i18n:text>xmlui.ArtifactBrowser.ItemViewer.show_qr</i18n:text></a>
        ...
        <xsl:choose>
            <xsl:when test="//mets:fileSec/mets:fileGrp[@USE='CONTENT' or @USE='BRANDED_PREVIEW' or @USE='ORIGINAL' or @USE='LICENSE']/mets:file">
                <div class="item-page-field-wrapper table word-break">
                    ...
                    <xsl:for-each select="//mets:fileSec/mets:fileGrp[@USE='CONTENT' or @USE='BRANDED_PREVIEW' or @USE='ORIGINAL' or @USE='LICENSE']/mets:file">
