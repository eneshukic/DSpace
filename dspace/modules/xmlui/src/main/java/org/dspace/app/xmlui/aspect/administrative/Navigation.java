...
public class Navigation extends AbstractDSpaceTransformer implements CacheableProcessingComponent
{
    ...
    private static final Message T_administrative_rate 			= message("xmlui.administrative.Navigation.administrative_rate");
            ...
            UIException, SQLException, IOException, AuthorizeException
    {
        ...
        if (isSystemAdmin)
        {
            ...
            registries.addItemXref(contextPath+"/admin/rate-registry",T_administrative_rate);
