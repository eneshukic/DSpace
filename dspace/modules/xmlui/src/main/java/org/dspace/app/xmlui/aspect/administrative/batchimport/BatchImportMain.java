...
public class BatchImportMain extends AbstractDSpaceTransformer {
    ...
    public void addBody(Body body) throws SAXException, WingException, SQLException
    {
        ...
        //UUID Id = UUID.fromString(parameters.getParameter("collectionID", null));
        String Id = parameters.getParameter("collectionID", null);
        ...
        //select.setOptionSelected(hid);
        select.setOptionSelected(Id);
        ...
        file.addFile("file");
         file.addHidden("collectionID").setValue(Id);
         file.addHidden("select-collection").setValue(hid);
